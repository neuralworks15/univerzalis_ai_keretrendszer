...
![Univerzális AI Keretrendszer](Misc/SZMPG_Matek_9-12.jpg)
...
| 03 Use Case | Az Univerzális AI Keretrendszerhez aktuálisan kidolgozott témaköröket (tantárgyakat) és hozzájuk tartozó felhasználói eseteket tartalmazza: <br> - Azonnal használható Use Case promptok (txt fájl) <br> - Use Case prompt legyártásához szükséges instrukciókat leíró MS word dokumentumokat tartalmazza. |
...
| 05 Template | Az Univerzális AI Keretrendszerhez kidolgozott template dokumentumokat tartalmazza: <br> - Template - Use Case Promptot. <br> - A tantárgyaknál használt Use Case prompt template fájlokat. <br> - Template - Use Case Prompt Factory-t. <br> - A tantárgyaknál használt Use Case prompt legyártásához szükséges instrukciókat tartalmazó dokumentumokat. |
