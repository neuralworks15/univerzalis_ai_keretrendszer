...
| 03 Use Case | Az Univerzális AI Keretrendszerhez aktuálisan kidolgozott témaköröket (tantárgyakat) és hozzájuk tartozó felhasználói eseteket tartalmazza: Azonnal használható Use Case promptok (txt fájl) és a Use Case prompt legyártásához szükséges instrukciókat leíró MS word dokumentumok |
| 04 Number Guess Game | Az Univerzális AI Keretrendszeren belül implementált klasszikus számkitalálós játék: chatGPT-ben implementált pszeudó programkód (prompt, txt fájl) |
